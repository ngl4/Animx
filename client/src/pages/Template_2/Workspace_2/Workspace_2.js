...
import Step1 from "../../Template_1/Workspace_1/instructional_images/step1.png";
import Step2 from "../../Template_1/Workspace_1/instructional_images/step2.png";
import Step3 from "../../Template_1/Workspace_1/instructional_images/step3.png";
import Step4 from "../../Template_1/Workspace_1/instructional_images/step4.png";
    ...
    return (
      <div>
        ...
        <div className="containerIMG" style={{ display: 'flex', justifyContent: 'center', }}>
           ...
           <Zoom left cascade>
             <div class="col-md-3">
             <span className="heading-title">are you ready to </span><a href="/template_2/workspace_2/content_2" className="animx-color"><strong>start</strong></a>
             </div>
             </Zoom>
         </div>
         </div>
